...
const Register = () => {
  ...
  return (
    <>
      {!clicked ? (
        <div className="container-fluid cyber-bg text-light py-5 position-relative">
          {/* Scanning Overlay */}
          <div className="hud-scan-overlay"></div>

          {/* Matrix Code */}
          <div className="matrix-overlay">01001001 00110100 01001100</div>

          <div className="text-center mb-5">
            <h1 className="neon-text display-3 glitch-flicker">Register</h1>
          </div>

          <div className="row cyber-card shadow-lg p-3 mb-5 rounded position-relative">
            {/* HUD Frame Overlay */}
            ...
            <div className="col-md-6 text-center">
              <img src={starlink} className="img-fluid rounded" alt="bytewars" />
            </div>
