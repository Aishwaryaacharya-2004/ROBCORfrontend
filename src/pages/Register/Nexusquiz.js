...
import character5 from '../../assets/compressed/character5.jpg';
...
const Register = () => {
  ...
  const [selectedEvent, setSelectedEvent] = useState("Nexus Quiz"); // default for demo
       ...
       <div className="cyber-bg cyber-content-wrapper">
            ...
            />
                    ...
                    <div className="form-container" style={{ flex: 1 }}>
                      <h1 className="mt-4">Nexus Quiz</h1>
                      <p className="arc-quote mt-4">
                        "Test your knowledge, challenge your mind, and emerge as the ultimate quiz champion!"
                      </p>
    ...
    <div className="cyber-content">
       <div className="cyber-card row">
          <div className="col-md-6 text-center mb-3 mb-md-0">
              <img src={quiz} className="event-image" alt="bytewars" />
                  </div>
  ...
  <div className="content">
    <p>- This event consists of 2 rounds.</p>
    <p>- The quiz will be conducted in online mode (using Slido platform).</p>
    <p>- The number of questions will be 40 in the first round and 20 in the second round.</p>
    <p>- Quiz round 1 start timing is 12:45 pm.</p>
    <p>- Round 2 timings will be announced later for those who qualify for round 1.</p>
    <p>- Quiz timings will be very strict; if you miss the slot, you will not get another chance.</p>
    <p>- The top 30 will be selected for round 2.</p>
    <p>- Winners are determined based on the maximum score.</p>
    <p>- If scores are tied for both participants, the winner will be declared based on timings.</p>
