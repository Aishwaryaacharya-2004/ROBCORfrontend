...
const Register = () => {
  ...
  const [selectedEvent, setSelectedEvent] = useState("Arduino Forge"); // default for demo
...
/>
        ...
        <div className="form-container" style={{ flex: 1 }}>
          ...
          <p className="arc-quote mt-4">
            "Debug, design, and dominate the circuit at Arduino Forge!"
          </p>
  ...
  <div className="cyber-content">
    <div className="cyber-card row">
      <div className="col-md-6 text-center mb-3 mb-md-0">
        <img src={projectSymposium} className="event-image" alt="arduinoforge" />
      </div>
      ...
      <div className="col-md-6">
        ...
        <div className="content">
          ...
          <p>- For the first round, a set of 30 questions on general technical skills will be provided</p>
          <p>- Top 7 teams of 1st round will be selected.</p>
          <p>- There will be 3 tasks in 2nd round, based on Arduino and electronics.</p>
          <p>- After completion of each task, next problem statement will be given</p>
          <p>- Arduino kit will be provided, participants will have to bring their own laptops.</p>
          <p>- All participants must be at venue 30 minutes before the event’s commencements</p>
          <p>- Judge’s decision will be final</p>
          <p>- Rules & Regulations may change without prior notice by the Event organizers</p>
        </div>
