...
import character2 from '../../assets/compressed/character2.jpg';
...
const Register = () => {
  ...
  const [selectedEvent, setSelectedEvent] = useState("Cyber Kick"); // default for demo
    ...
    return (
      ...
      <iframe
        ...
        style={{
          ...
          src="https://www.yepdesk.com/embed/buy-tickets/68233cbac9e77c0001f17764/private/8mco8gri6i"
        />
      </>
    );
  }
       ...
       <div className="cyber-bg cyber-content-wrapper">
            ...
            />
                    ...
                    <div className="form-container" style={{ flex: 1 }}>
                      <h1 className="mt-4">Cyber Kick</h1>
                      <p className="arc-quote mt-4">
                        "Kick, score, and rule the field with your robotic soccer skills!"
                      </p>
     ...
     <div className="cyber-content">
       <div className="cyber-card row">
         <div className="col-md-6 text-center mb-3 mb-md-0">
           <img src={droidkick} className="event-image" alt="bytewars" />
         </div>
   
         <div className="col-md-6">
           <h2 className="mt-4">{selectedEvent}</h2>
           <p className="cyber-head" ><strong >Timing:</strong> 10:30 AM</p>
           <p className="cyber-head"><strong >Venue:</strong>AICTE Lab</p>
  ...
  <p>2nd Prize : 3 K</p>
           ...
           <div className="content">
            <p>- The robot should fit inside a box of 30cm x 30cm x 30cm</p>
               ...
               <p>- If the ball goes out of arena, it will be placed in the centre and match will be resumed</p>
               <p>- In case of a tie, 3 penalties will be taken by each team</p>
               <p>- Human interference (e.g. touching the robot) during the game is not allowed.</p>
               <p>- No more AC/DC power supply will be provided at the sight of play</p>
           </div>
